...
// Search YouTube for a song (POST)
...
// Search YouTube for a song (GET - for easier testing)
...
// Get download status / check if audio is cached
...
// Auto-fetch: search and download in one call
